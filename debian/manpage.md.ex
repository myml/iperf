...
iperf3 - program to do something

# SYNOPSIS

**iperf3** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
...
:   The system-wide configuration file to control the behaviour of
    iperf3. See **foo.conf**(5) for further details.
...
**iperf3** provides some return codes, that can be used in scripts:
